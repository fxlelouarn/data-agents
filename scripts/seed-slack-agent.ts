...
import { AGENT_VERSIONS, getAgentName } from "@data-agents/types";
...
async function main() {
  ...
  const agentName = getAgentName("SLACK_EVENT");
  ...
  console.log(
    "   3. Optionnel: Définir les credentials directement (sinon env vars)",
  );
}
