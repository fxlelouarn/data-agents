...
import { FFAResultsAgent, FFA_RESULTS_AGENT_VERSION } from './FFAResultsAgent'
...
export { FFAResultsAgent, FFA_RESULTS_AGENT_VERSION }
...
export const AGENT_VERSIONS = {
  ...
  ffaResults: FFA_RESULTS_AGENT_VERSION,
